...
import fr.zenoobossdev.epiniumod.objects.recipes.diamond_furnace.DiamondFurnaceRecipes;
...
public class TileEntitySinteringFurnace extends TileEntity implements ITickable
{
    ...
    public void update()
    {
        ...
        {
            --this.burnTime;
            DiamondFurnace.setState(true, world, pos);
        }
        ...
        else
        {
            ...
            {
                ItemStack output = DiamondFurnaceRecipes.getInstance().getDiamondResult(inputs[0], inputs[1]);
                if(!output.isEmpty())
                {
                    smelting = output;
                    cookTime++;
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = DiamondFurnaceRecipes.getInstance().getDiamondResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));
