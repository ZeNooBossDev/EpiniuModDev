...
public class GuiSinteringFurnace extends GuiContainer
{
	...
	public GuiSinteringFurnace(InventoryPlayer player, TileEntitySinteringFurnace tileentity, EntityPlayer entityPlayer)
	{
		super(new ContainerSinteringFurnace(player, tileentity, entityPlayer));
		this.player = player;
